...
if __name__ == '__main__':
    ...
    prom_data = csv_dict_reader(import_file, export_fields)
    ...
    for chameleon_row in chameleon_data:
        for prom_row in prom_data:
            if chameleon_row[export_fields[1]] == prom_row[export_fields[1]]:
                ...
                price_goods = chameleon_row[export_fields[5]]
                rest_goods = chameleon_row[export_fields[21]]
                ...
                row[export_fields[5]] = price_goods #price_goods
                row[export_fields[20]] = goods_availability #goods_availability
                row[export_fields[21]] = rest_goods #rest_goods
